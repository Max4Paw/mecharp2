...
public class PalladiumSword extends Item {
    public PalladiumSword(ToolMaterial material, float attackDamage, float attackSpeed, Settings settings) {
        super(computeSettings(material, settings, attackDamage, attackSpeed, PalladiumConfig.unbreakablePalladium, PalladiumConfig.durabilityPalladium));
    }
