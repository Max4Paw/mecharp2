...
// PICKAXE_MINEABLE
        valueLookupBuilder(BlockTags.PICKAXE_MINEABLE)
                ...
                .add(BlockInit.ASBESTIT_ORE_BLOCK)
        ...
        ;
        valueLookupBuilder(ModTags.Blocks.PALLADIUM_PAXEL_MINEABLE)
                .forceAddTag(BlockTags.PICKAXE_MINEABLE)
                .forceAddTag(BlockTags.AXE_MINEABLE)
                .forceAddTag(BlockTags.SHOVEL_MINEABLE)
                .forceAddTag(ModTags.Blocks.NEEDS_PALLADIUM_TOOL);


        valueLookupBuilder(ModTags.Blocks.NEEDS_MAGMARIUM_TOOL)
                .add(BlockInit.MAGMARIUM_ORE_BLOCK)
                .add(BlockInit.BRONZE_ORE_BLOCK)
                .add(BlockInit.DEEPSLATE_BRONZE_ORE_BLOCK)
                .add(BlockInit.PALLADIUM_ORE_BLOCK)
        ...
        valueLookupBuilder(ModTags.Blocks.NEEDS_ASBESTIT_TOOL)
                .add(BlockInit.MAGMARIUM_ORE_BLOCK)
                .add(BlockInit.BRONZE_ORE_BLOCK)
                .add(BlockInit.DEEPSLATE_BRONZE_ORE_BLOCK)
                .add(BlockInit.PALLADIUM_ORE_BLOCK)
